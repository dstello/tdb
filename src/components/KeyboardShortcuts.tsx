...
export function Kbd({
  ...
  return (
    <kbd
      className={`inline-flex items-center justify-center min-w-4 h-4 rounded border border-border/40 bg-muted/30 px-1 font-mono text-[9px] text-white ml-1 ${className ?? ""}`}
    >
      {children}
    </kbd>
  );
