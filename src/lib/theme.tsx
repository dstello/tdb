...
export const themes: ThemeDefinition[] = [
  // Light themes
  {
    ...
    group: "light",
    className: null,
    swatch: "oklch(0.985 0.004 285)",
  },
  {
    id: "light-hc",
    label: "Light High Contrast",
    group: "light",
    className: "theme-light-hc",
    swatch: "oklch(0.42 0.20 285)",
  },
  // Dark themes
  {
    id: "dark",
    ...
    group: "dark",
    className: null,
    swatch: "oklch(0.72 0.14 285)",
  },
  {
    id: "dark-dimmed",
    label: "Dark Dimmed",
    group: "dark",
    className: "theme-dimmed",
    swatch: "oklch(0.65 0.10 220)",
  },
  {
    id: "dark-hc",
    label: "Dark High Contrast",
    group: "dark",
    className: "theme-dark-hc",
    swatch: "oklch(0.80 0.18 285)",
  },
];
